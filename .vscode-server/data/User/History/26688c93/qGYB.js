...
function guardarDatos(datos) {
    ...
    xhr.open("PUT", "url_del_servidor/datos.json", true); // Reemplaza "url_del_servidor" con la URL real de tu servidor
...
function obtenerDatos(callback) {
    ...
    xhr.open("GET", "url_del_servidor/datos.json", true); // Reemplaza "url_del_servidor" con la URL real de tu servidor
