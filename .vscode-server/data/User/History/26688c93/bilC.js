...
function guardarDatos(datos) {
    ...
    xhr.open("PUT", "http://localhost:3000/datos", true); // Reemplaza "url_del_servidor" con la URL real de tu servidor
...
function obtenerDatos(callback) {
    ...
    xhr.open("GET", "http://localhost:3000/datos", true); // Reemplaza "url_del_servidor" con la URL real de tu servidor
